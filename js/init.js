...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			'form':	{ range: '*', href: 'css/style-form.css', containers: 1400, grid: { gutters: 40 }, viewport: { scalable: false } },
		...
		plugins: {
			layers: {
				...
				sidePanel: {
					...
					height: '100%',
					clickToHide: true,
					html: '<div data-action="moveElement" data-args="header"><div class="overlay"></div></div>',
