(function($) {
  ...
  $('a h1.profile-logout').on('click', function(){
    console.log('click!');
    $.ajax({
      url : 'http://local.susiwebsite.com/mobdev1/user/logout.json', // deal with this!
      type : 'post',
      dataType : 'json',
  ...
  var jsons = {
                ...
                $.ajax({
                  ...
                  dataType : 'json',
                    error : function(XMLHTTPRequest, textStatus, errorThrown) {
                      alert('Either username / email and password is invalid. Please try again');
    ...
    redirect : function(name, email, id) {
