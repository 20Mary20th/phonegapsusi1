...
(function(e) {
    ...
    var n = "config",
        ...
        u = "trigger",
        f = "position",
        l = "_skel_layers_translate",
        c = "visibleWrapper",
        h = "_skel_layers_promote",
        p = "skel-layers-moved",
        d = "_skel_layers_demote",
        v = "$element",
        m = "moveToVisibleWrapper",
        g = "_skel_layers_resume",
        y = "moveToHiddenWrapper",
        b = "exclusiveLayer",
        w = "exclusive",
        E = "_skel_layers_cssNumericValue",
        S = "center",
        x = "css",
        T = "right",
        N = "bottom",
        C = "prototype",
        k = "skel-layers-css-values",
        L = "width",
        A = "_skel_layers_init",
        O = "_skel_layers_suspend",
        M = "left",
        _ = "_skel_layers_doTranslate",
        D = "overflow-x",
        P = "layers",
        H = "wrapper",
        B = "speed",
        j = "skel-layers-layer-z-index",
        F = "showstart",
        I = "hidestart",
        q = "transform",
        R = "iterate",
        ...
        K = "parent",
        Q = "length",
        G = ".skel-layers-fixed:not(.skel-layers-moved)",
        Y = !1,
        Z = "hideend",
        et = "showend",
        tt = "height",
        ...
        st = "unlockView",
        ot = "top",
        ut = "touchstart.lock click.lock scroll.lock",
        at = "skel-layers-handled",
        ft = "recalcW",
        lt = "element",
        ct = "hidden",
        ht = "_width",
        pt = !0,
        dt = '<div id="skel-layers-placeholder-',
        vt = "data",
        mt = "_skel_layers_uncss",
        gt = "_skel_layers_fadeOut",
        yt = "_skel_layers_recss",
        bt = "-webkit-",
        wt = "_skel_layers_fadeIn",
        Et = "100%",
        St = "blur",
        xt = "padding-bottom",
        Tt = "skel-layers-exclusiveVisible",
        Nt = "originalEvent",
        Ct = "easing",
        kt = "lockView",
        Lt = "useActive",
        At = "animation",
        Ot = "isInitialized",
        Mt = "-webkit-tap-highlight-color",
        _t = "skel-layers-layer-position",
        Dt = "z-index",
        Pt = "skel-layers-layer-index",
        Ht = "animations",
        Bt = "animate",
        jt = "#skel-layers-placeholder-",
        Ft = "skel_layers_hiddenWrapper",
        It = "_skel_layers_initializeCell",
        qt = "append",
        Rt = "resize.lock scroll.lock",
        Ut = "find",
        zt = "registerLocation",
        Wt = "hasClass",
        Xt = "undefined",
        ...
        Yt = "hide",
        Zt = "-moz-",
        en = "_skel_layers_expandCell",
        tn = "preventDefault",
        nn = "canUseProperty",
        rn = "_skel_layers_hasParent",
        sn = "backface-visibility",
        on = "attr",
        un = "events",
        an = "window",
        fn = "-webkit-transition",
        ln = "addClass",
        cn = "recalcH",
        hn = "visible",
        pn = "-ms-",
    ...
    t.registerPlugin(P, function(e) {
        ...
        return typeof e == Xt ? Y : (e.fn[d] = function() {
            ...
            }), r > 0 && (t[It](), t[x](L, (t[vt](Nn) + r) / 30 * 100 + "%"))
        }, e.fn[rn] = function() {
            ...
            switch (a.v) {
                ...
                case N:
                    ...
                    break;
                case S:
                    o[x](ot, "60%")[x]("margin-top", Fn + fr.getHalf(t[z]))
            }
            switch (a.h) {
                case M:
                    o[x](M, 0);
                ...
                case T:
                    ...
                    break;
                case S:
                    o[x](M, "60%")[x]("margin-left", Fn + fr.getHalf(t[ht]))
            }
